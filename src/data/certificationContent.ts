...
export const carrierCerts: CarrierCert[] = [
  ...
  { id: "humana", name: "Humana", color: "#3A9A34", status: "not-open" },
  { id: "aetna", name: "Aetna", color: "#7a2f86", status: "not-open" },
  { id: "anthem", name: "Anthem", color: "#0033A0", status: "not-open" },
  { id: "wellcare", name: "Wellcare", color: "#007A72", status: "not-open" },
  { id: "devoted", name: "Devoted Health", color: "#B8292F", status: "not-open" },
