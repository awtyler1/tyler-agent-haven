...
export const forms: FormItem[] = [
  ...
  { id: 'aep-field-playbook', category: 'planning', source: 'TIG', name: 'Medicare AEP Field Playbook (session slides)', description: 'The full deck from the August 21 AEP business planning session with Jeremy Boz and Eric Price. Two tracks (new broker and veteran), the priority stack, the six activity lanes, backward math from your enrollment goal, the scoreboard, and the eight-week cadence.', file: '/forms/aep-field-playbook.pptx' },
