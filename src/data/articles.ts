...
export const articles: Article[] = [
  {
    ...
    what: [
      { type: 'p', text: 'For years, Original Medicare paired with a Medicare Supplement was called the “Cadillac” of coverage. The market has shifted — most beneficiaries now drive Medicare Advantage instead.' },
      ...
      { type: 'ul', items: [
        'Bundled coverage — medical, hospital, and usually drug coverage in one plan, one card.',
        'Extra benefits most plans include — dental, vision, hearing, plus perks like gym memberships, OTC allowances, even home-delivered meals.',
        'Low premiums — 67% of MAPD members paid $0 in 2026 (KFF).',
      ] },
      { type: 'h', text: 'The trade-offs to be honest about' },
      { type: 'ul', items: [
        'Less predictable costs — copays and coinsurance until they hit the plan’s max out-of-pocket ($9,250 for 2026, often lower).',
        'Provider networks — HMO/PPO rules, possible referrals, and their doctor may not be in-network.',
        'Hard to reverse — switching back to a Med Supp later can require medical underwriting outside a guaranteed-issue window.',
      ] },
    ],
    why: [
      'More of your clients are going to ask for MA. Your value isn’t just enrolling them — it’s matching the right client to the right plan and setting honest expectations.',
