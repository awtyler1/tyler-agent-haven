...
export const articles: Article[] = [
  {
    ...
    whatTitle: 'The one question under every FMO decision',
    what: [
      { type: 'p', text: "There is one question that decides whether you are building a business or renting one, and most agents never ask it out loud: if I leave, do my clients and my renewals come with me? The honest answer depends entirely on how your contract is written, not on how friendly your recruiter was." },
      { type: 'h', text: 'Direct pay vs. assigned commissions' },
      { type: 'p', text: "When you write a Medicare Advantage or Supplement policy, the carrier pays a commission. The only question is who it flows to first. There are two models, and they lead to very different places." },
      { type: 'p', text: "Direct pay: the carrier pays you the full commission at the CMS maximum, straight to you. The FMO earns a separate override from the carrier, on top of your check, not out of it. Your name is on the contract. If you leave, your renewals keep coming to you and your book moves with you." },
      { type: 'p', text: "Assigned commissions, often called LOA or licensed-only-agent: the carrier pays the agency, and the agency pays you a share. The book is contracted under them. If you leave, the renewals can stay with the agency. You built it. They keep it." },
      { type: 'h', text: 'How to tell which one you have' },
      { type: 'ul', items: [
      ...
      { type: 'h', text: 'Where release fits in' },
      { type: 'p', text: "Owning your book and being able to leave are two different locks on the same door. Even a direct-pay agent needs a release to move a carrier contract to a new upline. A fair FMO states its release policy in writing and does not use it as a leash. Most carriers also let you change your hierarchy once a year without any release at all, around the anniversary of your contract. Knowing that one fact takes a lot of the fear out of the whole decision." },
      { type: 'p', text: "The trap to avoid is an upline that will not put release terms in writing, or buries them, or quietly delays releases for months. If a company needs to hold you hostage to keep you, that tells you exactly what they think their value is." },
      { type: 'h', text: 'How TIG does it' },
      { type: 'p', text: "We built TIG on the model above. You are paid directly by the carrier at the full commission, your book is yours, and our release terms are in writing. Our brother company, Crowe and Associates, runs on the exact same structure, and Ed has said the same thing in public for years: full commission, paid direct, you own the book. We think that is the only honest way to run an FMO. It is also just good business, because agents who are free to leave and choose to stay are the ones worth building with." },
    ],
    why: [
  ...
  },
  {
    ...
    actions: [
      "Confirm you are paid at street level. Ask directly: am I paid the full CMS commission by the carrier? If not, find out exactly what split you are on and why.",
      "Ignore highest commission claims until you have checked they are not just describing street level or hand-waving at the override.",
      "If you are considering an LOA deal for leads or salary, write down what you are giving up in commission and ownership, and decide if the trade is worth it for where you are right now.",
      "Judge FMOs on what they build with the override, not on the override itself. Tools, training, support, release terms, book ownership. That is the real comparison.",
    ],
  },
  {
    ...
    whatTitle: 'The 2026 and 2027 numbers for Kentucky',
    what: [
      { type: 'p', text: "Every year CMS sets the maximum a carrier can pay a Medicare agent, and Kentucky falls in the national tier, so these are your numbers. Here is what a Kentucky agent can be paid at full street level." },
      { type: 'h', text: 'Medicare Advantage (MA / MAPD)' },
      { type: 'ul', items: [
        "2026: $694 for a new enrollment, $347 per renewal year.",
        "2027: $725 for a new enrollment, $363 per renewal year.",
      ] },
      { type: 'h', text: 'Prescription drug plans (Part D)' },
      { type: 'ul', items: [
        "2026: $114 new, $57 renewal.",
        "2027: $130 new, $65 renewal. That is a 14% jump, the biggest raise in the table.",
      ] },
      { type: 'p', text: "Medicare Supplement, or Medigap, works differently. It is not capped by CMS. It pays a percentage of premium, commonly in the high teens to low twenties percent in the first year, and it renews for several years. That mix of Medicare Advantage, Part D, and Supplement is what a healthy Kentucky book looks like." },
      { type: 'h', text: 'Why renewals are the real number' },
      { type: 'p', text: "The new-enrollment figure gets all the attention, but the renewal is where a Medicare book becomes a business. A renewal pays you every year the client stays on the plan, for doing nothing new. Build a book of 300 Medicare Advantage lives and, at the 2027 renewal rate, that is roughly $108,000 a year in renewals alone, before you write a single new policy that year. That is the difference between a job and an asset." },
      { type: 'p', text: "Round numbers, and real books vary with retention, plan changes, and chargebacks. But the shape is right, and it is why the agents who last stop chasing new applications and start protecting the book they already have." },
      { type: 'h', text: 'What the 2027 changes signal' },
      { type: 'p', text: "Two things stand out this year. First, CMS raised the Part D commission the most, a clear nudge to write more standalone drug plans. Second, the marketing rules loosened for 2027: the 48 hour waiting period after a Scope of Appointment is gone, which makes same-day appointments easier. Read both as the same message. It is a good season to be an active, compliant Medicare agent in Kentucky." },
    ],
    why: [
