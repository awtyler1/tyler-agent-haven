...
// Route: /kentucky-medicare-market-report
// ----------------------------------------------------------------------------
// A fully-sourced synthesis of public CMS / KFF / Census / AHR / MedPAC data,
// compiled for the AGENT audience. Every stat traces to a named source and year
// in the Sources section. This is the GEO / digital-PR citation asset: data +
// sources is what AI engines cite. Report / Article schema is injected at
// prerender time (scripts/prerender.mjs via entry-server).
//
