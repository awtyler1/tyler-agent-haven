    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-colors border-border/50",
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal text-foreground aria-selected:opacity-100 hover:bg-accent/60 transition-colors rounded-md"
        ),
